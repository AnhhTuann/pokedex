      ...
      <table style="width:100%; border-collapse: separate; border-spacing: 0; margin: 24px 0; border: 1px solid rgba(139, 92, 246, 0.2); border-radius: 12px; overflow: hidden; background-color: rgba(15, 15, 25, 0.5);">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="padding: 12px 16px; color: #cbd5e1;">Xuất hiện tại **Rumination Field** thuộc khu rừng Pinwheel Forest sau khi Cobalion thức tỉnh. Nổi tiếng with chỉ số kháng phép và tốc độ lướt điệu nghệ.</td>
          </tr>
        </tbody>
      </table>
      ...
      <table style="width:100%; border-collapse: separate; border-spacing: 0; margin: 24px 0; border: 1px solid rgba(16, 185, 129, 0.2); border-radius: 12px; overflow: hidden; background-color: rgba(15, 15, 25, 0.5);">
        ...
        <tbody>
          <tr>
            ...
            <td style="padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.04); color: #cbd5e1; font-weight: bold;">Petilil (Hệ Cỏ)</td>
            <td style="padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.04); text-align: center;">
              <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/546.png" alt="Cottonee" style="max-width:40px;" />
            </td>
            <td style="padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.04); font-weight: bold; color: #10b981;">Cottonee (Hệ Cỏ)</td>
            <td style="padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.04);"><strong>Nacrene City:</strong> Đổi Petilil hoang dã lấy Cottonee (chỉ dành riêng cho bản White!). Giúp bạn có ngay chú bông gòn siêu lầy lội chống chịu cực tốt.</td>
          </tr>
          <tr>
            <td style="padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.04); text-align: center;">
        ...
        <table style="width:100%; border-collapse: separate; border-spacing: 0; margin: 24px 0; border: 1px solid rgba(16, 185, 129, 0.2); border-radius: 12px; overflow: hidden; background-color: rgba(15, 15, 25, 0.5);">
          ...
          <tbody>
            <tr>
              ...
              <td style="padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.04); color: #cbd5e1; font-weight: bold;">Petilil (Grass)</td>
              <td style="padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.04); text-align: center;">
                <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/546.png" alt="Cottonee" style="max-width:40px;" />
              </td>
              <td style="padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.04); font-weight: bold; color: #10b981;">Cottonee (Grass)</td>
              <td style="padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.04);"><strong>Nacrene City:</strong> Trade a wild Petilil for a high-IV Cottonee (White Exclusive). Ideal to secure an early-game defensive support companion!</td>
            </tr>
            <tr>
              <td style="padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.04); text-align: center;">
                <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/525.png" alt="Boldore" style="max-width:40px;" />
            ...
            <tr>
              ...
              <td style="padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.04);"><strong>Route 4 (Gatehouse):</strong> Swap a Minccino to acquire a Blue-Striped Basculin (White) or Red-Striped Basculin (Black).</td>
            </tr>
            <tr>
              <td style="padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.04); text-align: center;">
                <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/132.png" alt="Ditto" style="max-width:40px;" />
            ...
            <tr>
              ...
              <td style="padding: 12px 16px;"><strong>Undella Town (Summer):</strong> Trade a wild Cinccino in the camper van to receive Munchlax.</td>
            </tr>
          </tbody>
        </table>
      `;
