export const SOULSILVER_CHAPTERS = [
  {
    ...
    content: `
      ...
      <p>Chào mừng bạn đến với vùng đất Johto trù phú trong phiên bản làm lại đỉnh cao thế hệ 4 - Pokémon SoulSilver! Cuộc phiêu lưu huyền thoại của bạn sẽ bắt đầu tại Thị trấn New Bark yên bình.</p>
      ...
      <blockquote style="border-left: 4px solid #3b82f6; padding: 12px 16px; margin: 24px 0; background-color: rgba(59, 130, 246, 0.05); border-radius: 0 12px 12px 0;">
        <strong>Mẹo eSports:</strong> Trong SoulSilver, Pokémon đi đầu sẽ luôn đi theo sau bạn trên bản đồ dã ngoại! Hãy thường xuyên tương tác với chúng để tăng độ thân mật và nhận những phụ kiện dễ thương nhé.
      </blockquote>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Hành trình tiến về thành phố cổ kính Ecruteak City - cái nôi văn hóa lưu giữ truyền thuyết về các vị thần hộ mệnh vùng Johto.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Đoạt huy hiệu vinh dực, bước ra khỏi cửa gặp vợ Chuck để được trao ban chiếc máy bay lượn thần tốc <strong>HM02 Fly</strong> giúp bạn di chuyển cực kỳ nhanh chóng trên toàn cõi Johto!</p>
    `
  },
  {
    gameVersion: "soulsilver",
  ...
  },
  {
    ...
    content: `
      ...
      <p>Pryce trong SoulSilver có cấp độ cao hơn hẳn bản gốc (Lvl 30-34), sở hữu những đòn băng tuyết siêu rát dũng mãnh:</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Càn quét toàn bộ tháp, giả dạng cải trang lính Rocket rồi dập tắt âm mưu của các Executive cấp cao (Proton, Petrel, Ariana, Archer). Giải cứu Giám đốc đài phát thanh để được ban tặng thần vật linh thiêng: <strong>Silver Wing</strong> (Cánh Bạc - thần vật dùng để triệu gọi thần biển cả Lugia).</p>
  ...
  {
    gameVersion: "soulsilver",
    chapterTitle: "Phần 10: Điệu múa Kimono Girls & Diện kiến thần biển cả Lugia xuất thế",
    order: 10,
    language: "vi",
    content: `
      <h1>Phần 10: Điệu múa Kimono Girls & Diện kiến thần biển cả Lugia xuất thế</h1>
      <p>Đây là điểm nâng cấp rực rỡ nhất về mặt cốt truyện của Pokémon SoulSilver, bắt buộc người chơi phải đối mặt chuỗi đấu đỉnh cao trước khi vượt biển gọi thần!</p>
      ...
      <h2>2. Vượt Quần đảo Whirl Islands diện kiến Thần Biển Cả Lugia (Level 45)</h2>
      <p>Sau khi vượt qua thử thách, các Kimono Girls sẽ tiến thẳng tới quần đảo **Whirl Islands**. Hãy bơi qua sóng biển, dùng chiêu Whirlpool vượt xoáy nước tiến sâu vào hang động thác nước ẩn, chứng kiến điệu múa lụa cầu thần kỳ diệu kết hợp chiếc chuông triều tịch **Tidal Bell** để triệu gọi thần thú biển cả **Lugia (Level 45)** xuất đầu diện diện!</p>
      <div style="text-align: center; margin: 24px 0;">
        <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/249.png" alt="Lugia" style="max-width: 110px;" />
        <p style="font-style: italic; color: #3b82f6; margin-top: 8px;">Thần biển cả đại dương Lugia rực sáng kiêu hãnh dưới động thác Whirl Islands!</p>
      </div>
      <blockquote>
        <strong>Mẹo eSports:</strong> Lugia ngự trị ở Level 45 sở hữu tuyệt kỹ độc quyền **Aeroblast** có sát thương bạo kích cực cao cùng khả năng phòng thủ vô địch nhờ song hệ Tâm Linh/Bay. Hãy dùng các đòn giật điện hoặc đóng băng để khống chế nó và thu phục bằng Heavy Ball hoặc Ultra Ball!
      </blockquote>
    `
  },
  {
    ...
    content: `
      ...
      <ul>
        <li><strong>Đội hình:</strong> Xatu (Lvl 40), Jynx (Lvl 41), Exeggutor (Lvl 41), Slowbro (Lvl 41), Xatu (Lvl 42).</li>
        <li><strong>Khắc chế:</strong> Sử dụng đòn hệ Bóng Tối của Umbreon/Houndoom hoặc sấm giật của Ampharos lên Slowbro và song hệ Xatu. Dùng chiêu lửa sấy khô Jynx và Exeggutor.</li>
      </ul>

      <h2>2. Độc thủ Ninja Koga</h2>
      <ul>
        <li><strong>Đội hình:</strong> Ariados (Lvl 40), Venomoth (Lvl 41), Forretress (Lvl 43), Muk (Lvl 42), Crobat (Lvl 44).</li>
        <li><strong>Khắc chế:</strong> Forretress cực kì sợ Lửa ($\times 4$). Dùng đòn hệ Lửa nướng chín con kén sắt này. Dùng đòn hệ Đất/Tâm Linh dọn dẹp Muk và sấm sét bắn rụng Crobat tốc độ cao.</li>
      </ul>

      <h2>3. Quyền Vương Bruno</h2>
      <ul>
        <li><strong>Đội hình:</strong> Hitmontop (Lvl 42), Hitmonlee (Lvl 42), Hitmonchan (Lvl 42), Onix (Lvl 43), Machamp (Lvl 46).</li>
        <li><strong>Khắc chế:</strong> Dìm chết Onix bằng Surf nước xoáy. Sử dụng đòn bay lượn hệ Chim hoặc đòn hệ Tâm Linh cực bạo phát (Psybeam/Psychic) để thổi bay các đấu sĩ đấm đá.</li>
      </ul>

      <h2>4. Nữ hoàng Bóng Đêm Karen</h2>
      <ul>
        <li><strong>Đội hình:</strong> Umbreon (Lvl 42), Vileplume (Lvl 42), Gengar (Lvl 45), Murkrow (Lvl 44), Houndoom (Lvl 47).</li>
        <li><strong>Khắc chế:</strong> Dùng đòn Giác đấu (Machamp/Machop) đấm vỡ giáp Umbreon cực lẹ. Dùng đòn Thủy lướt Surf dập sập lửa tối của Houndoom dứt điểm!</li>
      </ul>
      ...
      <table style="width:100%; border-collapse: separate; border-spacing: 0; margin: 24px 0; border: 1px solid rgba(239, 68, 68, 0.2); border-radius: 12px; overflow: hidden; background-color: rgba(15, 15, 25, 0.5);">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.04); color: #cbd5e1;">Ru ngủ vô đối rồi dập đòn thảo mộc cực bạo. Hãy dùng lực siêu sát của Lugia hoặc sấy khô từ xa bơi lội.</td>
          </tr>
          <tr>
            <td style="padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.04); text-align: center;">
  ...
  {
    gameVersion: "soulsilver",
    chapterTitle: "Phần 13: Toàn tập HMs, Vật phẩm đặc trưng vùng Johto-Kanto bản SoulSilver",
    order: 13,
    language: "vi",
    content: `
      <h1>Phần 13: Toàn tập HMs, Vật phẩm đặc trưng vùng Johto-Kanto bản SoulSilver</h1>
...
export const ENGLISH_SOULSILVER_CHAPTERS = SOULSILVER_CHAPTERS.map(viChapter => {
  let title = "";
  let content = "";
  ...
  switch (viChapter.order) {
    case 1:
      ...
      content = `
        ...
        <p>Welcome to the beautiful land of Johto in the ultimate Gen 4 remake - Pokémon SoulSilver! Your legendary adventure begins in the quiet and peaceful New Bark Town.</p>
        ...
        <blockquote style="border-left: 4px solid #3b82f6; padding: 12px 16px; margin: 24px 0; background-color: rgba(59, 130, 246, 0.05); border-radius: 0 12px 12px 0;">
          <strong>eSports Tip:</strong> In SoulSilver, the leading Pokémon of your party will physically walk behind you in the overworld! Interact with them to inspect their mood and collect items.
        </blockquote>
    ...
    case 5:
      ...
      content = `
        ...
        <p>Arrive at Ecruteak City, the cultural capital of Johto where the legends of the legendary guardians reside.</p>
    ...
    case 8:
      ...
      content = `
        ...
        <p>In SoulSilver, Pryce's team is significantly higher leveled (Lvl 30-34):</p>
    ...
    case 9:
      ...
      content = `
        ...
        <p>Sweep through the tower, dismantle the operations, and defeat the highest executives (Proton, Petrel, Ariana, Archer). The Director hands you the ultimate **Silver Wing** to meet Lugia.</p>
    ...
    case 10:
      title = "Chapter 10: The Dance of Kimono Girls & Summoning Ocean-God Lugia";
      content = `
        <h1>Chapter 10: The Dance of Kimono Girls & Summoning Ocean-God Lugia</h1>
        <p>This is the highlight of Pokémon SoulSilver's story, mandating a gauntlet of five tough matches before traveling to the Whirl Islands!</p>
        ...
        <h2>2. Navigating the Whirl Islands to Capture Lugia (Level 45)</h2>
        <p>Once cleared, the Kimono Girls assemble inside **Whirl Islands**. Surf out to the islands, cross the deep whirlpool channels, descend into the majestic cavern waterfalls, and witness the traditional summoning dance. Your Tidal Bell and Silver Wing will awaken the oceanic deity **Lugia (Level 45)**!</p>
        <div style="text-align: center; margin: 24px 0;">
          <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/249.png" alt="Lugia" style="max-width: 110px;" />
          <p style="font-style: italic; color: #3b82f6; margin-top: 8px;">The oceanic protector Lugia appearing inside the Whirl Islands cavern!</p>
        </div>
        <blockquote>
          <strong>eSports Tip:</strong> Lugia is challenged at Level 45, wielding its unique Special move **Aeroblast** (which has 100 power and an increased critical hit ratio). Target its weaknesses carefully while managing its enormous Sp. Def, or put it to sleep and capture with Heavy Balls or Ultra Balls!
        </blockquote>
      `;
      break;
    ...
    case 11:
      ...
      content = `
        ...
        <ul>
          <li><strong>Team:</strong> Xatu (Lvl 40), Jynx (Lvl 41), Exeggutor (Lvl 41), Slowbro (Lvl 41), Xatu (Lvl 42).</li>
          <li><strong>Strategy:</strong> Exploit weaknesses using Dark types (Umbreon/Houndoom) or Electric types on Slowbro and Xatus. Burn down Jynx and Exeggutor.</li>
        </ul>

        <h2>2. Poison Koga</h2>
        <ul>
          <li><strong>Team:</strong> Ariados (Lvl 40), Venomoth (Lvl 41), Forretress (Lvl 43), Muk (Lvl 42), Crobat (Lvl 44).</li>
          <li><strong>Strategy:</strong> Forretress takes 4x damage from Fire moves. Melt it down instantly. Use Psychic or Ground moves to sweep Muk and Electric moves to shoot down Crobat.</li>
        </ul>

        <h2>3. Fighting Bruno</h2>
        <ul>
          <li><strong>Team:</strong> Hitmontop (Lvl 42), Hitmonlee (Lvl 42), Hitmonchan (Lvl 42), Onix (Lvl 43), Machamp (Lvl 46).</li>
          <li><strong>Strategy:</strong> Drown Onix with Surf. Utilize Psychic or Flying types to sweep past his muscle-bound fighters.</li>
        </ul>

        <h2>4. Dark Karen</h2>
        <ul>
          <li><strong>Team:</strong> Umbreon (Lvl 42), Vileplume (Lvl 42), Gengar (Lvl 45), Murkrow (Lvl 44), Houndoom (Lvl 47).</li>
          <li><strong>Strategy:</strong> Smash Umbreon with physical Fighting moves. Drown Houndoom with Surf.</li>
        </ul>
        ...
        <table style="width:100%; border-collapse: separate; border-spacing: 0; margin: 24px 0; border: 1px solid rgba(239, 68, 68, 0.2); border-radius: 12px; overflow: hidden; background-color: rgba(15, 15, 25, 0.5);">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.04);">Lvl 84</td>
              <td style="padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.04);">Frenzy Plant, Sleep Powder</td>
              <td style="padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.04); color: #cbd5e1;">Spams Sleep Powder and heavy Grass moves. Target its typing with Lugia's psychic blows.</td>
            </tr>
            <tr>
              <td style="padding: 12px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.04); text-align: center;">
                <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/9.png" alt="Blastoise" style="max-width:45px;" />
    ...
    case 13:
      title = "Chapter 13: Complete HMs, Key Items & Trades in SoulSilver";
      content = `
        <h1>Chapter 13: Complete HMs, Key Items & Trades in SoulSilver</h1>
    ...
    case 15:
      ...
      content = `
        ...
        <p>Held Items enhance your builds significantly inside the Frontier:</p>
